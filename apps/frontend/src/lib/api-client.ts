...
export function newRequestKey(): string {
  ...
  // LAN HTTP exposes getRandomValues but not the secure-context-only randomUUID method.
...
export function apiErrorFromResponse(response: Response, raw: unknown): ApiError {
